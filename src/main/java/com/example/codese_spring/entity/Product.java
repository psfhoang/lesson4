...
public class Product {
  ...
  public Product(String productID, String display, int priceIn, int priceOut, int priceSale,
      int amount, int shipday, String description, String images, String create_at,
      String update_at) {
