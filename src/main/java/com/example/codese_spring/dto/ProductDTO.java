...
public class ProductDTO {
    ...
    public ProductDTO(String productID, String display, Integer priceIn, Integer priceOut, Integer priceSale, Integer amount, Integer shipday, String description, String images) {
