...
public class ReceiptController {
  ...
  @PostMapping("/create")
  public ResponseEntity<ResponseForm<Boolean>> createReceiptDetails(
      @RequestBody OrderReqDto orderReqDto, HttpServletRequest request) {
    return ResponseEntity
        .ok(ResponseForm.buildCustomResponse(receiptService.createReceipt(orderReqDto), 1, "oke"));

  }

  @GetMapping("/all")
  public ResponseEntity<ResponseForm<List<ReceiptInfor>>> showAllReceipt() {
